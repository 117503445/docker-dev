...
pacman -Syu which zsh fish btop git openssh docker docker-compose docker-buildx nano vim micro net-tools dnsutils inetutils iproute2 traceroute base-devel parted tmux python wget --noconfirm
